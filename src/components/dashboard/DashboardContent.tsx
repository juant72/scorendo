...
import { Target, Trophy, Flame, Percent, Clock, Zap, ArrowRight, ShieldCheck, Activity, Sparkles } from 'lucide-react';
...
import { locales, translateTeamName, translateContestName } from '@/lib/locales';
              ...
              <div className="flex-1 text-center md:text-left pt-2">
                 <div className="flex flex-wrap items-center gap-4 mb-4 justify-center md:justify-start">
                    <div className="px-4 h-7 bg-primary/10 border border-primary/30 rounded-full flex items-center gap-2">
                       ...
                       <span className="text-[10px] font-black uppercase text-primary tracking-widest">{t.tacticalElite}</span>
                    </div>
                    <div className="px-4 h-7 bg-white/5 border border-white/10 rounded-full flex items-center gap-2">
                       <Activity size={12} className="text-white/40" />
                       <span className="text-[10px] font-black uppercase text-white/40 tracking-widest">{t.activeId}: {shortAddress}</span>
                    </div>
                 </div>
           ...
           <div className="w-full lg:w-96 bg-[#060D1A] rounded-[2.5rem] border-2 border-white/5 p-8 relative overflow-hidden group shadow-2xl">
              ...
              <div className="flex items-center justify-between mb-8">
                 <div className="flex items-center gap-3 text-primary">
                    ...
                    <span className="text-[10px] font-black uppercase tracking-[0.3em]">{t.operationalSlot}</span>
                 </div>
              ...
              {nextMatch ? (
                 <>
                    <div className="space-y-1 mb-8">
                       <span className="text-white/40 text-[10px] font-black uppercase tracking-widest leading-none">{t.tMinusWindow}</span>
                       <h3 className="text-4xl font-black text-white italic tracking-tighter">{timeLeftHrs} {t.hours}</h3>
                    </div>
                    <div className="flex items-center gap-4 bg-black/40 p-4 rounded-2xl border border-white/5 mb-8">
                       ...
                       <div className="flex flex-col">
                          <span className="text-[9px] font-black text-white/30 uppercase tracking-widest">{t.objectiveArena}</span>
                          <span className="text-xs font-black text-white uppercase truncate max-w-[150px]">{(nextMatch.homeTeam?.name ? translateTeamName(nextMatch.homeTeam.name, locale) : null) || t.sectorAlpha}</span>
                       </div>
                    </div>
                    <Link href="/contests" className="w-full h-14 bg-primary text-midnight rounded-2xl flex items-center justify-center gap-3 font-black text-[11px] uppercase tracking-widest hover:bg-white transition-all shadow-xl shadow-primary/20">
                       {t.deployIntel} <ArrowRight size={16} />
                    </Link>
                 </>
              ) : (
                 <div className="py-10 text-center space-y-4">
                    <Sparkles className="mx-auto text-white/5" size={40} />
                    <p className="text-white/20 text-[10px] font-black uppercase tracking-widest">{t.noActiveDeployments}</p>
                    <Link href="/contests" className="text-primary text-[10px] font-black uppercase tracking-widest underline decoration-2 underline-offset-4">{t.browseSectors}</Link>
                 </div>
              )}
           </div>
        </div>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 mb-24">
           ...
           <div className="bg-[#060D1A] p-8 rounded-[2rem] border-2 border-white/5 relative overflow-hidden group hover:border-gold/30 transition-all">
              ...
              <div className="flex items-center gap-3 text-white/30 mb-6">
                 ...
                 <span className="text-[9px] font-black uppercase tracking-[0.3em]">{t.stats.totalIntel}</span>
              </div>
              <div className="flex flex-col">
                 <span className="text-5xl font-black text-white italic tracking-tighter leading-none mb-1">{user.totalPoints}</span>
                 <span className="text-[10px] font-black text-gold/40 uppercase tracking-widest">{t.stats.legacyPoints}</span>
              </div>
           </div>
           ...
           <div className="bg-[#060D1A] p-8 rounded-[2rem] border-2 border-white/5 relative overflow-hidden group hover:border-primary/30 transition-all">
              ...
              <div className="flex items-center gap-3 text-white/30 mb-6">
                 ...
                 <span className="text-[9px] font-black uppercase tracking-[0.3em]">{t.stats.tacticalHits}</span>
              </div>
              <div className="flex flex-col">
                 <span className="text-5xl font-black text-white italic tracking-tighter leading-none mb-1">{user.totalExact}</span>
                 <span className="text-[10px] font-black text-primary/40 uppercase tracking-widest">{t.stats.exactPrecisions}</span>
              </div>
           </div>

           {/* Stat: Streak */}
           <div className="bg-[#060D1A] p-8 rounded-[2rem] border-2 border-orange-500/30 relative overflow-hidden group hover:border-orange-500/30 transition-all">
              ...
              <div className="flex items-center gap-3 text-white/30 mb-6">
                 ...
                 <span className="text-[9px] font-black uppercase tracking-[0.3em]">{t.stats.momentum}</span>
              </div>
              <div className="flex flex-col">
                 <span className="text-5xl font-black text-white italic tracking-tighter leading-none mb-1">{user.bestStreak}</span>
                 <span className="text-[10px] font-black text-orange-500/40 uppercase tracking-widest">{t.stats.maxCombo}</span>
              </div>
           </div>
           ...
           <div className="bg-[#060D1A] p-8 rounded-[2rem] border-2 border-primary/20 relative overflow-hidden group shadow-xl">
              ...
              <div className="flex items-center gap-3 text-primary mb-6">
                 ...
                 <span className="text-[9px] font-black uppercase tracking-[0.3em]">{t.stats.precisionRating}</span>
              </div>
              <div className="flex flex-col">
                 <span className="text-5xl font-black text-primary italic tracking-tighter leading-none mb-1">{user.accuracy.toFixed(1)}%</span>
                 <span className="text-[10px] font-black text-primary/40 uppercase tracking-widest">{t.stats.strikeRate}</span>
              </div>
           </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
           ...
           <div className="lg:col-span-8">
              <div className="flex items-center justify-between mb-10 pb-6 border-b border-white/5">
                 ...
                 <Link href="/contests" className="text-[9px] font-black text-primary hover:text-white uppercase tracking-widest flex items-center gap-2 transition-all">
                    {t.viewCompleteLog} <ArrowRight size={12} />
                 </Link>
              </div>
              ...
              <div className="space-y-4">
                 {user.predictions.length === 0 ? (
                    <div className="bg-[#060D1A] rounded-[3rem] p-24 text-center border-2 border-dashed border-white/5">
                       ...
                       <h3 className="text-2xl font-black text-white uppercase italic tracking-tighter opacity-40">{t.noSignalDetected}</h3>
                       <p className="text-[10px] font-black text-white/20 uppercase tracking-[0.4em] mt-4">{t.commenceOps}</p>
                    </div>
                 ) : (
                       ...
                       <div key={pred.id} className="bg-[#060D1A] rounded-3xl p-6 border border-white/5 hover:border-primary/20 transition-all flex flex-col md:flex-row md:items-center justify-between gap-6 group">
                          <div className="flex items-center gap-10">
                             <div className="flex items-center gap-4">
                                <TeamBadge name={translateTeamName(pred.match.homeTeam.name, locale)} code={pred.match.homeTeam.code} size="sm" sport="football" isAway={false} />
                                <span className="text-[10px] font-black text-white/20 italic">{t.versus}</span>
                                <TeamBadge name={translateTeamName(pred.match.awayTeam.name, locale)} code={pred.match.awayTeam.code} size="sm" sport="football" isAway={true} homeCode={pred.match.homeTeam.code} />
                             </div>
                             <div className="h-10 w-px bg-white/5 hidden md:block" />
                             <div>
                                <h4 className="text-[10px] font-black text-white uppercase tracking-widest mb-1">{translateContestName(pred.contest.name, locale)}</h4>
                                <span className="text-[9px] font-black text-white/20 uppercase tracking-widest">{t.sectorIntel}</span>
                             </div>
                          </div>
                          
                          <div className="flex items-center justify-between md:justify-end gap-10">
                             <div className="text-center">
                                <span className="block text-[8px] font-black text-white/30 uppercase tracking-widest mb-1">{t.estimated}</span>
                             ...
                             <div className="min-w-[80px] text-right">
                                {pred.scored ? (
                                   <div className={`inline-flex items-center gap-2 px-4 h-8 rounded-xl font-black text-[9px] uppercase tracking-widest ${pred.pointsEarned > 0 ? 'bg-primary/10 text-primary border border-primary/20' : 'bg-red-500/10 text-red-500 border border-red-500/20'}`}>
                                      {pred.pointsEarned > 0 ? `+${pred.pointsEarned} ${t.pointsEarned}` : t.loss}
                                   </div>
                                ) : (
                                   <div className="flex items-center gap-2 text-white/20">
                                      <Clock size={12} />
                                      <span className="text-[9px] font-black uppercase tracking-widest">{t.pending}</span>
                                   </div>
                                )}
                             </div>
                          </div>
           ...
           <div className="lg:col-span-4 space-y-12">
                 ...
                 <div className="space-y-4">
                    {user.contestEntries.length === 0 ? (
                       <div className="bg-[#060D1A]/50 p-10 rounded-[2rem] border-2 border-dashed border-white/5 text-center">
                          ...
                          <p className="text-[10px] text-white/20 font-black uppercase tracking-widest">{t.noCompetitionsInit}</p>
                       </div>
                    ) : (
                             ...
                             <div key={entry.id} className="relative rounded-3xl overflow-hidden group border border-white/5 hover:border-primary/40 transition-all h-32 flex flex-col justify-end p-6">
                                ...
                                <div className="relative z-10 flex items-center justify-between">
                                   <div>
                                      ...
                                      <span className="text-[9px] font-black text-primary uppercase tracking-widest">{entry.contest.status} {t.protocol}</span>
                                   </div>
                                   <div className="flex flex-col items-end">
                                      <span className="text-xl font-black text-white italic tabular-nums">{entry.finalPoints}</span>
                                      <span className="text-[8px] font-black text-white/40 uppercase tracking-widest">{t.ptsRank}</span>
                                   </div>
                                </div>
                             </div>
                          );
              ...
              <div className="bg-primary/5 rounded-[2.5rem] border-2 border-primary/20 p-8 space-y-6 relative overflow-hidden group">
                 ...
                 <h3 className="text-xl font-black text-white uppercase italic tracking-tighter">{t.pathToMasteryPrefix} <span className="text-primary">{t.pathToMasteryHighlight}</span></h3>
